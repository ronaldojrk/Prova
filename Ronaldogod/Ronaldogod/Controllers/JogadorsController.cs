...
namespace Ronaldogod.Controllers
{
    public class JogadorsController : Controller
    {
        ...
        public JogadorsController(RonaldogodContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Idade,nascionalidade")] Jogador jogador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Idade,nascionalidade")] Jogador jogador)
        {
            if (id != jogador.Id)
            {
                return NotFound();
